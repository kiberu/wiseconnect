...
<div class="br-mainpanel">
  <div class="br-pageheader">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
      ...
      <a class="breadcrumb-item" href="<?php echo e(route('groups.index')); ?>">Group</a>
                  ...
                  <div class="row no-gutters">
                    <div class="col-md-12 mg-t--1 mg-md-t-0">
                      <div class="form-group">
                        ...
                        <input class="form-control <?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Enter group name">
                    ...
                    <div class="col-md-12 mg-t--1 mg-md-t-0">
                      <div class="form-group mg-md-l--1">
                        ...
                        <input class="form-control <?php echo e($errors->has('landmark') ? ' is-invalid' : ''); ?>" type="text" name="landmark" value="<?php echo e(old('landmark')); ?>" placeholder="Enter location landmark">
