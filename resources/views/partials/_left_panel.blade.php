...
<div class="br-sideleft sideleft-scrollbar">
  ...
  <ul class="br-sideleft-menu">
    ...
    <li class="br-menu-item">
      ...
      <ul class="br-menu-sub">
        <li class="sub-item"><a href="accordion.html" class="sub-link">Loans</a></li>
        <li class="sub-item"><a href="alerts.html" class="sub-link">Installments</a></li>
        <li class="sub-item"><a href="buttons.html" class="sub-link">Defaulters</a></li>
      </ul>
    </li><!-- br-menu-item -->
    <li class="br-menu-item">
      <a href="#" class="br-menu-link with-sub">
